...
public:
	...
	_float3 GetPosition() { return m_xmf3Position; }
...
public:
	...
	CVertex GetVertex(int iIndex) { return m_pVertices[iIndex]; }
};
...
public:
	...
	virtual void Render(HDC hDCFrameBuffer, _float3* pCullingPosition = nullptr, float fCullingOffset = 0.f);
